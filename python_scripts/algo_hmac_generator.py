...
def generate_hmac_auth(
    password, method, uri, content_md5="", content_type="application/json"
):
    """
    ...
    # Generate HMAC key
    hmac_key = hmac.new(
        password.encode("utf-8"), hmac_input.encode("utf-8"), hashlib.sha256
    ).hexdigest()
...
if __name__ == "__main__":
    ...
    auth_data = generate_hmac_auth(
        "algo", "POST", "/api/controls/tone/start", content_md5
    )
    print("\nPOST Request Auth:")
